        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimingStart = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TimingEnd = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    SportTypesJson = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TurfId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    TurfName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TurfPhoto = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavoriteTurfs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FavoriteTurfs_Turfs_TurfId",
                        column: x => x.TurfId,
                        principalTable: "Turfs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FavoriteTurfs_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavoriteTurfs_TurfId",
                table: "FavoriteTurfs",
                column: "TurfId");

            migrationBuilder.CreateIndex(
                name: "IX_FavoriteTurfs_UserId_TurfId",
                table: "FavoriteTurfs",
                columns: new[] { "UserId", "TurfId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Slots_TurfId_Date",
                table: "Slots",
                columns: new[] { "TurfId", "Date" });
